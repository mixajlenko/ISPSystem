...
<body class="u-body">
<section class="u-align-center u-clearfix u-hidden-md u-hidden-sm u-hidden-xs u-section-1" id="sec-ad5e">
    <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <%--                <h2 class="u-align-center u-text u-text-4">Main page</h2>--%>
        <%--                <h5 class="u-align-center u-text u-text-5">Welcome string</h5>--%>
        <%--                <p class="u-align-center u-text">service 1</p>--%>
        <%--                <p class="u-align-center u-text">service 2<br>--%>
        <%--                </p>--%>
        <%--            </div>--%>
        <%--        </div>--%>
        <div class="u-border-1 u-border-grey-75 u-container-style u-group u-white u-group-2">
            <div class="u-container-layout u-container-layout-2">
                <h2 class="u-align-center u-text ">Main page</h2>
                <p class="u-align-center u-text">service 1</p>
                <p class="u-align-center u-text">service 2<br>
            </div>
        </div>
