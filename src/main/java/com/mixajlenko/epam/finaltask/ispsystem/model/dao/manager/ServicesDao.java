...
import com.mixajlenko.epam.finaltask.ispsystem.model.dao.entity.Service;
...
public class ServicesDao extends ConnectionSupport implements IEntityDAO<Service> {

    public ServicesDao(DaoFactory dataSource) {
        super(dataSource);
    }
    ...
    @Override
    public boolean updateEntity(Service entity) throws SQLException {
        Connection connection = dataSource.getConnection();
        connection.setAutoCommit(false);
    ...
    @Override
    public boolean insertEntity(Service entity) throws SQLException {
        Connection connection = dataSource.getConnection();
        connection.setAutoCommit(false);
